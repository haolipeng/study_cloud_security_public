...
| ServiceType   | 0x00       | Request（最低位=0表示请求，=1表示响应） |
| Xid           | 0x0000068b | 事务标识符，用于匹配请求和响应          |
| ResponseDelay | 0x00C0     | 设备应在随机延迟后响应，避免响应风暴    |
| DCPDataLength | 0x0004     | 后续 Block 数据的总长度为 4 字节        |
