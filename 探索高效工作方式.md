...
5、整理测试过程中的全部pcap数据集，提交到gitlab仓库



1、固件写入请求和响应的解析功能实现代码 

2、固件写入请求和响应的解析功能测试和bug修复 

1、ASN.1 BER 解码基础库测试和bug修复 - 2个 

2、GetNameList类型请求和响应解析的测试和bug修复 - 3个 

3、getVariableAccessAttr类型请求和响应解析的测试和bug修复 - 2个 

4、getNamedVarListAttr类型请求和响应解析的测试和bug修复 

5、Read类型的Confirmed-Request/Confirmed-Response深度解析的测试和bug修复

6、文件下载场景的请求和响应解析的测试和bug修复

7、Write类型的Confirmed-Request/Confirmed-Response深度解析的测试和bug修复 
